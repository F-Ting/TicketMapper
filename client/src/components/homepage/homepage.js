...
/*
Opens home page with sign in options.s
User also has option to register or browse website as guest.
Personal accounts to be implemented in A3.
*/
...
class NewHomePage extends Component {
    ...
    componentDidMount() {
        //setTimeout(function () { this.props.dispatch({ type: "SIGN_UP_SUCCESS_BAR_COMPLETE" }) }.bind(this), 3000);
    }
            ...
            <div className="home-container">
                ...
                <div className="home-inputs">
                    <Form>
                        ...
                        <Button className="home-signin-guest-btn" color="secondary" size="md" onClick={this.handleGuest}>Sign In As Guest</Button>
                    </Form>
                </div>
            </div>
        )
