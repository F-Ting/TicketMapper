...
/*
Returns a list of attractions that a user is following.
        ...
        return (
            <div className="followingpage-container">
                ...
                {this.props.attractionList.length === 0 ?
                    <div>
                        <h2 className="followingpage-following-error">No Attractions Followed!</h2>
                    </div> :
                    <div>
                        <Form>
                            <h2 className="followingpage-following-error">Attractions Currently Followed</h2>
                                    ...
                                    <div className="followingpage-follow" key={attraction.performerID}>
                                        <Container>
                                            <Row>
                                                ...
                                                <Col xs="2">
                                                    <Button color="danger" size="md" onClick={() => this.handleUnfollow(this.props.userID, attraction.performerID, this.props.attractionList)}>Unfollow</Button>
                                                </Col>
                                            </Row>
                                        </Container>
                                    </div>
