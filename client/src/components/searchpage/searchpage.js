...
/*
User can input a search query for an attraction in the search bar. User should be redirected to the results page.
*/
...
class SearchPage extends Component {
  constructor(props) {
    ...
    //this.props.dispatch(user.fetchUser(this.props.user))
